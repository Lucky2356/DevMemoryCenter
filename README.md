...
See [docs/development/BUILDING.md](docs/development/BUILDING.md). Security and privacy constraints are described in [SECURITY.md](SECURITY.md), [THREAT_MODEL.md](THREAT_MODEL.md), and [PRIVACY.md](PRIVACY.md).
